        ...
        <div className='space-y-2'>
          <div className='flex flex-col justify-between gap-2'>
            <div className=' flex flex-row items-center gap-2 text-base font-medium text-gray-700 dark:text-gray-300'>
              <Skeleton className='h-2 w-[20px]' /> | <Skeleton className='h-2 w-[20px]' />
            </div>
            <div className='mb-4 w-32 text-base sm:hidden md:mb-0'>
              <Skeleton className='h-4 w-[50px]' />
            </div>
          </div>
          <div className='text-base flex flex-col gap-1 font-semibold text-gray-700 dark:text-gray-300'>
        ...
        <span className='flex flex-row flex-wrap justify-center gap-2 sm:justify-end'>
          {newTags?.map((tag) => (
            <span key={tag} className='mr-2 inline-block rounded-lg bg-sky-700 px-3 py-1 text-sm font-semibold text-white'>
              <Skeleton className='h-4 w-[30px] bg-white' />
            </span>
          ))}
        </span>
      </div>

...
export default async function Todo() {
  ...
  if (!session?.user)
    return (
      <div className='flex min-h-screen w-11/12 sm:w-3/4 mx-auto flex-col items-center gap-10 justify-center'>
...
export default async function PrivatePage() {
  ...
  if (!session?.user)
    return (
      <div className='flex min-h-screen w-4/5 mx-auto flex-col items-center gap-10 justify-center'>
  ...
  return (
    <div className='mt-20 flex flex-col min-h-screen justify-center items-center'>
...
export default async function PrivatePage() {
  ...
  return (
    <div className='mt-20 flex flex-col space-y-5 min-h-screen justify-center items-center'>
      <p>Hello {session.user.name}</p>
